...
3. **Define outcomes first.** Express desired behavior as testable acceptance criteria before writing any code.
4. **Write the test first (Red).** Create a focused failing test that defines one behavior. Confirm it fails for the right reason.
